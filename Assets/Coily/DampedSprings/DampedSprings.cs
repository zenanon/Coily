...
namespace Coily
{
	...
	/// <summary>
	/// A port of Ryan Juckett's damped springs code, see License and Readme.
	/// </summary>
	public class DampedSprings
	{
		//******************************************************************************
		...
		/// <summary>
		/// Get the updated position/velocity for a given spring setup.
		/// </summary>
		public static void UpdateSpringMotion(ref float position,
			ref float velocity,
			...
			float dampingRatio)
		{
			DampedSpringMotionParams dampedSpringMotionParams = new DampedSpringMotionParams();
			CalcDampedSpringMotionParams(ref dampedSpringMotionParams, deltaTime, angularFrequency, dampingRatio);
			UpdateDampedSpringMotion(ref position, ref velocity, equilibriumPosition, dampedSpringMotionParams);
		}
		...
		//******************************************************************************
		private static void CalcDampedSpringMotionParams(
			ref DampedSpringMotionParams pOutParams, // motion parameters result
